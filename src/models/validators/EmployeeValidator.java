...
public class EmployeeValidator {
    public static List<String> validate(Employee e, Boolean code_duplicate_check_flag, Boolean password_check_flag){
        ...
        String password_error = _validateName(e.getPassword());
    ...
    private static String _validateCode(String code, Boolean code_duplicate_check_flag){
        ...
        if(code_duplicate_check_flag){
            ...
            long employee_count = (long)em.createNamedQuery("checkRegistersdCode", Long.class).setParameter("code", code).getSingleResult();
            em.close();
            if(employee_count > 0){
